...
xdg-open http://localhost:5000 2>/dev/null || sensible-browser http://localhost:5000 2>/dev/null || echo "  Open http://localhost:5000 in your browser"
